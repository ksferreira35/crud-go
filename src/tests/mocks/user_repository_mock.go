...
import (
	...
	res_err "github.com/ksferreira35/crud-go/src/config/res_err"
	model "github.com/ksferreira35/crud-go/src/model"
...
func (m *MockUserRepository) CreateUser(userDomain model.UserDomainInterface) (model.UserDomainInterface, *res_err.RestErr) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUser", userDomain)
	ret0, _ := ret[0].(model.UserDomainInterface)
	ret1, _ := ret[1].(*res_err.RestErr)
	return ret0, ret1
}
...
func (m *MockUserRepository) DeleteUser(userId string) *res_err.RestErr {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteUser", userId)
	ret0, _ := ret[0].(*res_err.RestErr)
	return ret0
}
...
func (m *MockUserRepository) FindUserByEmail(email string) (model.UserDomainInterface, *res_err.RestErr) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByEmailAndPassword(email, password string) (model.UserDomainInterface, *res_err.RestErr) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByID(id string) (model.UserDomainInterface, *res_err.RestErr) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) UpdateUser(userId string, userDomain model.UserDomainInterface) *res_err.RestErr {
	m.ctrl.T.Helper()
